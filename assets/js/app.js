  ...
  function v() {
    ...
    !t ||
      ...
      ((o = document.createElement("ul")).innerHTML =
        '<a href="#" class="logo"><img src="assets/images/logo-light.svg" alt="" height="22"></a>'),
      Array.from(
...
navbar.innerHTML = `
  <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item" id='Manage-patient-files'>
              ...
              <div class="collapse menu-dropdown " id="sidebarDashboards">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item ">
                    <a href="/Manage-patient-files/Programs/Programs.html" class="nav-link  ">
                      البرامج </a>
                  </li>
                  <li class="nav-item">
                    <a href="/Manage-patient-files/Reports.html" class="nav-link ">
                      التقارير </a>
                  </li>
                  <li class="nav-item">
                    <a href="/Manage-patient-files/settings.html" class="nav-link"> الإعدادت
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <li class="nav-item" id='Laboratory-nav'>
              ...
              <div class="collapse menu-dropdown " id="Laboratory">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
            ...
            <li class="nav-item" id='Path-nav'>
              ...
              <div class="collapse menu-dropdown " id="Laboratory1">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="/pathology/Programs.html" class="nav-link">
                      البرامج </a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a href="/pathology/settings.html" class="nav-link ">
                      الإعدادت
                    </a>
                  </li>
                </ul>
            ...
            <li class="nav-item" id="Stores-nav">
              ...
              <div class="collapse menu-dropdown " id="Laboratory2">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="/Stores/Programs.html" class="nav-link">
                      البرامج </a>
                  </li>
                  <li class="nav-item">
                    <a href="/Stores/Reports/index.html" class="nav-link"> التقارير
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/Stores/settings.html" class="nav-link ">
                      الإعدادت
                    </a>
                  </li>
                </ul>
            ...
            <li class="nav-item">
              <a class="nav-link menu-link" href="#Laboratory4" data-bs-toggle="collapse" role="button"
                ...
                <img src="/assets/images/box.png" /><span>المخازن </span>
              </a>
              <div class="collapse menu-dropdown " id="Laboratory4">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="/the-stores/Programs.html" class="nav-link">
                      البرامج </a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a href="/the-stores/settings.html" class="nav-link ">
                      الإعدادت
                    </a>
                  </li>
                </ul>
            ...
            <li class="nav-item" id='PricingContracts-nav'>
              ...
              <div class="collapse menu-dropdown " id="PricingContracts">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="/PricingContracts/Programs.html" class="nav-link ">
                      البرامج </a>
                  </li>
                  <li class="nav-item">
                    <a href="/PricingContracts/Reports.html" class="nav-link"> التقارير
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <li class="nav-item" id='Approvals-nav'>
              ...
              <div class="collapse menu-dropdown " id="Approvals">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="/Approvals/Programs.html" class="nav-link ">
                      البرامج </a>
                  </li>
                  <li class="nav-item">
                    <a href="/Approvals/Reports.html" class="nav-link"> التقارير
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/Approvals/Settings.html" class="nav-link ">
                      الإعدادت
                    </a>
                  </li>
                </ul>
            ...
            <li class="nav-item" id='B2B-nav'>
              ...
              <div class="collapse menu-dropdown " id="B2B">
                <ul class="nav nav-sm flex-column">
                  ...
                  <li class="nav-item">
                    <a href="/B2B/Reports.html" class="nav-link"> التقارير
                    </a>
                  </li>
                  <li class="nav-item">
            ...
            <li class="nav-item" id="emp-nav">
              ...
              <div class="collapse menu-dropdown " id="Laboratory7">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="/Hr/Programs.html" class="nav-link">
                      البرامج </a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a href="/Hr/settings.html" class="nav-link ">
                      الإعدادت
                    </a>
                  </li>
                </ul>
